...
namespace System.Web.Mvc
{
    ...
    public class UrlHelper
    {
        ...
        private string GenerateUrl(string routeName, string actionName, string controllerName,
        ...
        public static string GenerateUrl(string routeName, string actionName, string controllerName, string protocol,
